...
def sampling(alpha, beta=None, weighted=False, n_samples=1, *params, **kwargs):
    """
    ...
    list of numpy.ndarray
        List containing n_samples network edge lists. Each edge list is a numpy array where:
    ...
    if weighted:
        assert beta is not None, "Beta is required for sampling weighted networks with Enhanced Configuration Model"
